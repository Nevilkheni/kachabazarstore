    ...
    <section className="bg-white w-full px-4 sm:px-10">
      <div className="max-w-[1456px] mx-auto py-10 lg:py-20 ">
        ...
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          ...
          use of KachaBazars Website, located at https://kachabazar.com/. By
        ...
        <h2 className="text-md font-bold text-gray-900 ">Cookies </h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          We employ the use of cookies. By accessing KachaBazar, you agreed to
          use cookies in agreement with the KachaBazars Privacy Policy. Most
        ...
        <h2 className="text-md font-bold text-gray-900 ">License </h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
        ...
        <td>
          <ol className="list-decimal pl-4 space-y-1 text-gray-900">
            ...
            <li>
              ...
              characteristics) Parts of this website offer an opportunity for
              users to post and exchange opinions and information in certain
              areas of the website. KachaBazar does not filter, edit, publish or
              review Comments prior to their presence on the website. Comments
              do not reflect the views and opinions of KachaBazar,its agents
              ...
              by applicable laws, KachaBazar shall not be liable for the
        ...
        <h2 className="text-md font-bold text-gray-900 ">Content Liability</h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          ...
          violation of, any third party rights.Without prior approval and
        ...
        <h2 className="text-md font-bold text-gray-900 ">Your Privacy</h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
        ...
        <h2 className="text-md font-bold text-gray-900 ">Disclaimer</h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
