    ...
    <section className="bg-white w-full px-4 sm:px-10">
      <div className="max-w-[1456px] mx-auto py-10 lg:py-20 ">
        ...
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          ...
          by KachaBazar and how we use it. If you have additional questions or
          require more information about our Privacy Policy, do not hesitate to
          contact us.we may receive additional information about you such as
        ...
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          ...
          shared and/or collect in KachaBazar.we may receive additional
          information about you such as your name, email address, phone number,
          the contents of the message and/or attachments you may send us, we may
          ask for your contact information, including items such as name,
          company name, address, email address, and telephone number. This
        ...
        <h2 className="text-md font-bold text-gray-900 ">Consent </h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
        ...
        <h2 className="text-md font-bold text-gray-900 ">Log Files</h2>
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          KachaBazar follows a standard procedure of using log files. These
          files log visitors when they visit websites. All hosting companies do
          this and a part of hosting. The information collected by log files
        ...
        <p className=" text-base opacity-90 leading-6 text-gray-900 mb-4">
          ...
          on KachaBazar, which are sent directly to users browser. They
