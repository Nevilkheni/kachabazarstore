...
// import products from "@/app/data/LatestProducts.json";
...
//   return (
//     <section className="w-full py-10 lg:py-16 px-3 sm:px-10 bg-gray-50">
//       <div className="max-w-[1456px] mx-auto">
//         <div className="text-center mb-8 lg:w-[40%] mx-auto">
...
//           </p>
//         </div>
//         <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-6 gap-2 md:gap-3 mt-10">
//           {products.map((item) => {
...
//                       width={192}
//                       height={192}
//                       className={`object-cover p-2 lg:p-0 lg:my-2 duration-300 transform ${
...
import { useDispatch, useSelector } from "react-redux";
import { addToCart, removeFromCart } from "@/app/redux/cartSlice";
import { getLatestProducts } from "@/app/api/getProducts";
