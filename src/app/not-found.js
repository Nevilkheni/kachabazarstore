...
export default function NotFound() {
    return (
        <div className="flex flex-col items-center justify-center py-32 text-center bg-gray-50">
            <h1 className="text-md   font-sans font-medium text-blue-600 ">404</h1>
            <h1 className="mt-4 text-3xl font-bold tracking-tight font-sans text-gray-900  sm:text-5xl">Page not found</h1>
