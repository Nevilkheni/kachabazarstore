...
export default function NeedtoReview() {
    ...
    return (
        <div className="px-2 sm:px-6 py-3 bg-gray-50 h-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2  xl:grid-cols-4 gap-2 sm:gap-3 mb-8">
                {currentProducts.map((product) => (
                    <div key={product.id} className="bg-white shrink-0 min-w-[225px] rounded-lg p-2  border border-gray-100">
